	...
	<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback">
        ...
        <view class="cu-bar bg-white search" :style="[{top:CustomBar + 'px'}]">
			...
			<view v-if="queryIndex==2" class="search-form round">
				<text class="cuIcon-search"></text>
				<input v-model="searchForm.qiandaoshijian" type="text" placeholder="签到时间" ></input>
			</view>
			<view class="action">
		...
		<button :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,0) inset","backgroundColor":"#409EFF","borderColor":"#409EFF","borderRadius":"40rpx","color":"#fff","borderWidth":"1","width":"80%","fontSize":"28rpx","borderStyle":"solid","height":"80rpx"}' v-if="isAuth('qiandao','新增')" class="add-btn" @click="onAddTap()">新增</button>
	...
	export default {
		...
		methods: {
			...
			queryChange(e) {
				...
				this.searchForm.qiandaoshijian="";
			},
			//类别搜索
			...
			async search(){
				...
				let searchForm = {
					...
					searchForm['xingming'] = '%' + this.searchForm.xingming + '%'
																...
																if(this.searchForm.qiandaoshijian){
					searchForm['qiandaoshijian'] = '%' + this.searchForm.qiandaoshijian + '%'
				}	

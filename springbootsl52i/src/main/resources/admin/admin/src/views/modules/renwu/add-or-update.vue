    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="任务编号" prop="renwubianhao">
          <el-input v-model="ruleForm.renwubianhao" 
              placeholder="任务编号" clearable  :readonly="ro.renwubianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="任务编号" prop="renwubianhao">
              <el-input v-model="ruleForm.renwubianhao" 
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="任务类型" prop="renwuleixing">
          <el-select v-model="ruleForm.renwuleixing" placeholder="请选择任务类型">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="任务难度" prop="renwunandu">
          <el-select v-model="ruleForm.renwunandu" placeholder="请选择任务难度">
            <el-option
                v-for="(item,index) in renwunanduOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="任务难度" prop="renwunandu">
	      <el-input v-model="ruleForm.renwunandu"
                placeholder="任务难度" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="任务详情" prop="renwuxiangqing">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.renwuxiangqing" label="任务详情" prop="renwuxiangqing">
                    <span v-html="ruleForm.renwuxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	zhaopian : false,
      ...
      rules: {
          ...
          renwunandu: [
                { required: true, message: '任务难度不能为空', trigger: 'blur' },
          ],
          jifen: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jieshushijian = true;
          ...
          if(o=='renwunandu'){
            this.ruleForm.renwunandu = obj[o];
	    this.ro.renwunandu = true;
            continue;
          }
          if(o=='jifen'){
	...
	this.ruleForm.renwuxiangqing = this.ruleForm.renwuxiangqing.replace(reg,'../../../springbootsl52i/upload');
        } else {
          this.$message.error(data.msg);
        }
      });

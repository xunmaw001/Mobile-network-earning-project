<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="物品详情" prop="wupinxiangqing">
          <el-input v-model="ruleForm.wupinxiangqing" 
              placeholder="物品详情" clearable  :readonly="ro.wupinxiangqing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="物品详情" prop="wupinxiangqing">
              <el-input v-model="ruleForm.wupinxiangqing" 
                placeholder="物品详情" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `duihuanwupin/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.duihuanwupinCrossAddOrUpdateFlag = false;
                  this.parent.search();
